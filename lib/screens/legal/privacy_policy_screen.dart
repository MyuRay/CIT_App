        ...
        child: Column(
          ...
          children: [
            ...
            const Text(
              ...
              '\n'
              'アカウントと関連データの削除は、「マイページ」→「設定」→「アカウント削除」から申請できます。'
              '運営者が申請を確認して削除を行い、対応予定と完了結果を登録メールアドレスへご案内します。申請の送信時点では削除は完了しません。\n'
              '削除対象は、認証アカウント、プロフィール、時間割・出欠、投稿・コメント・レビュー（Cwitter・ちばちゃんねるを含む）、アップロード画像、通知登録などの関連データです。\n'
